<!DOCTYPE html>
  ...
  <nav>
    ...
    <form action="http://localhost/abn.php" method="post" target="iframe">
      <input type="hidden" name="abn" value = "4444444444">
      <button type="submit" style="width:30%; height:40px; margin : 10px">tttsd</button>
    </form>
